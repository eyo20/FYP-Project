...
$subjects_query = "SELECT * FROM subjects WHERE tutor_id = ?";
...
// Fetch tutor information
$tutor_query = "SELECT t.*, u.email FROM tutors t 
...
// Close database connection
$conn->close();
>>>>>>> c5374a70e22af57631337018b9b5d803bb6f0773:booking html(templete).php
?>