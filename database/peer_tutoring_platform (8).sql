...
INSERT INTO `courses` (`course_id`, `faculty`, `programme`, `course_code`, `course_name`, `requirement`) VALUES
(1, 'Business', 'Accounting', 'TAC 2413', 'Accounting', 'Master Degree in Business'),
(2, 'Business', 'Finance and Banking', 'TFB 2113', 'Finance and Banking', 'Master Degree in Business'),
(3, 'Business', 'Digital Business', 'TDB 4163', 'Digital Business', 'Master Degree in Business'),
(4, 'Information Technology', 'Computer Security', 'TCS 1427', 'Computer Security', 'Master Degree in Information Technology'),
(5, 'Information Technology', 'Business Impact Analysis', 'TBA 2527', 'Business Impact Analysis', 'Master Degree in Information Technology'),
(6, 'Information Technology', 'Artificial Intelligence', 'TAI 5261', 'Artificial Intelligence', 'Master Degree in Artificial Intelligence'),
(7, 'Engineering', 'Mechanical Engineering', 'TME 5381', 'Mechanical Engineering', 'Master Degree in Engineering');
...
INSERT INTO `students` (`id`, `student_name`, `faculty`, `programme`, `course_code`, `status`) VALUES
