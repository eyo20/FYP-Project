...
(2, 'Staff', 'Staff123.', 'staff123@gmail.com\r\n', 'System', 'Staff', '2025-06-17 05:54:22');
...
(16, 'Final Year Project', NULL, 'active', '2025-06-19 03:37:46', '2025-06-19 03:37:46'),
(17, 'Human Machine Interaction', NULL, 'active', '2025-06-19 03:38:02', '2025-06-19 03:38:02');
...
(1, 16, 25, 'Hi', '2025-06-12 03:21:17', 1, 0),
(2, 25, 16, 'Hi', '2025-06-12 03:21:44', 1, 0),
(8, 16, 17, 'Hi', '2025-06-15 23:19:48', 1, 0),
(9, 17, 25, 'Hi', '2025-06-16 02:47:05', 0, 0),
(10, 17, 25, 'Good Morning', '2025-06-16 03:12:09', 0, 0),
(89, 23, NULL, 'hi', '2025-06-19 10:00:18', 0, 1),
(90, 16, NULL, 'hi', '2025-06-19 10:03:22', 0, 1),
(91, 32, NULL, 'hi', '2025-06-19 10:37:50', 0, 1),
(92, 32, 17, 'hi', '2025-06-19 10:49:51', 1, 0),
(93, 32, 21, 'Hi', '2025-06-19 10:50:14', 0, 0),
(94, 32, NULL, 'hi', '2025-06-19 10:55:27', 0, 1),
(95, 32, 17, 'hi', '2025-06-19 10:55:33', 1, 0),
(96, 23, 17, 'Hi', '2025-06-19 11:41:16', 0, 0);
...
(1, 3, 25, 16, 5, 'Good', 0, NULL, '2025-06-16 14:21:42');
...
(2, 16, 23, 2, 2, 'completed', '2025-06-03 09:00:00', '2025-06-03 11:00:00', NULL, NULL, '2025-06-03 19:08:31'),
(3, 16, 23, 3, 1, 'completed', '2025-06-03 09:00:00', '2025-06-03 11:00:00', NULL, NULL, '2025-06-03 19:25:39'),
(4, 16, 23, 2, 2, 'completed', '2025-06-06 09:00:00', '2025-06-06 11:00:00', NULL, NULL, '2025-06-03 20:20:42'),
(5, 16, 23, 2, 1, 'rejected', '2025-06-04 09:00:00', '2025-06-04 11:00:00', NULL, NULL, '2025-06-03 22:40:01'),
(6, 16, 23, 6, 3, 'completed', '2025-06-05 09:00:00', '2025-06-05 11:00:00', NULL, NULL, '2025-06-03 22:56:28');
...
(10, 16, 23, 3, 1, '', '2025-06-03', '', 'confirmed', '2025-06-04 03:25:27'),
(11, 16, 23, 2, 2, '', '2025-06-06', '', 'confirmed', '2025-06-04 03:46:06'),
(12, 16, 23, 2, 1, '', '2025-06-04', '', 'rejected', '2025-06-04 04:21:29'),
(13, 16, 23, 6, 3, '', '2025-06-05', '', 'confirmed', '2025-06-04 06:55:50'),
(14, 16, 23, 1, 3, '', '2025-06-04', '', 'confirmed', '2025-06-04 07:11:24'),
(15, 16, 23, 1, 1, '12:00-14:00', '2025-06-20', '', 'confirmed', '2025-06-15 04:34:36'),
(16, 16, 23, 3, 1, '08:00-10:00', '2025-06-25', '', 'pending', '2025-06-15 04:39:58'),
(17, 16, 23, 6, 3, '08:00-10:00', '0000-00-00', '\nCancellation reason: nothing', 'cancelled', '2025-06-15 04:44:17'),
(18, 16, 23, 1, 1, '08:00-10:00', '2025-06-18', '', 'confirmed', '2025-06-15 05:18:37');
...
(23, 'Computer Science', 'Foundation', '', 'IT', 'approved', NULL, NULL, NULL, NULL),
(25, 'Computer Science', 'Master', '', 'IT', 'rejected', NULL, '2025-05-25 16:26:59', '2025-05-25 16:27:41', 'Mengwen\r\n');
...
(16, 'Computer Science', 'Diploma', 'hello', '1', 1, 4.20, 0, 'IT', 'approved'),
(19, '1', 'Master', '1', '1', 0, 1.50, 0, 'IT', 'rejected');
...
CREATE TABLE `user` (
  ...
  `email` varchar(100) NOT NULL,
  `role` enum('student','tutor','admin','staff') NOT NULL,
  `first_name` varchar(50) NOT NULL,
  `last_name` varchar(50) NOT NULL,
...
(16, 'mingwen', '$2y$10$9BtLg9AS1waXzlUC7YArjeiRhxLax9jZFSa5pLbcv5oKgLAzlXb/i', 'mingwen123@student.mmu.edu.my', 'tutor', 'mingwengg', 'koh', '0123456789', 'Uploads/profile_images/16_1750093927_Controller.png', 1, '2025-04-23 17:15:45', NULL),
...
(26, 'Staff', '$2y$10$tLJ5v5zYV.8Q9Z7XUxwYrOeWm1nKjBbGv2hYsDpNq3tJkMlVH6fDy', 'staff123@gmail.com', 'staff', 'System', 'Staff', NULL, NULL, 1, '2025-06-17 05:52:47', NULL),
(30, 'Staff 2', '$2y$10$UleUPfxB9jY0et30/f7Ie.jhuHd2RhUmtF4o96VkNBf7osczv8dZe', 'staff222@gmail.com', 'staff', '', '', NULL, NULL, 1, '2025-06-17 19:49:23', NULL),
(32, 'Test', '$2y$10$Y223eNqI8bgnhW8cwPLWy.4TgtegGWM0Ne9jIz1x0GREBephmPJyC', 'test@student.mmu.edu.my', 'tutor', 'Test', 'Test', NULL, NULL, 1, '2025-06-19 02:33:59', NULL);
