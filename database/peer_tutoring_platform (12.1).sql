...
INSERT INTO `cgpa_file` (`file_id`, `file_name`, `file_path`, `file_type`, `upload_date`, `is_verified`, `verified_by`, `verification_date`, `status`, `rejection_reason`, `user_id`) VALUES
(1, '', '', '', '2025-05-23 08:40:19', 0, NULL, NULL, 'pending', NULL, 16);
...
INSERT INTO `courses` (`course_id`, `course_code`, `course_name`, `requirement`) VALUES
(0, 'TAI 6666', 'Artificial Intelligence', 'Master Degree in Information Technology'),
(1, 'TAC 2413', 'Accounting', 'Master Degree in Business'),
(2, 'TFB 2113', 'Finance and Banking', 'Master Degree in Business'),
(3, 'TDB 4163', 'Digital Business', 'Master Degree in Business'),
(4, 'TCS 1427', 'Computer Security', 'Master Degree in Information Technology'),
(5, 'TBA 2527', 'Business Impact Analysis', 'Master Degree in Information Technology'),
(6, 'TAI 5261', 'Artificial Intelligence', 'Master Degree in Artificial Intelligence'),
(7, 'TME 5381', 'Mechanical Engineering', 'Master Degree in Engineering');
...
(5, 16, 25, 4, 2, 2, '2025-06-03', '\nCancellation reason: because not sure enough', 'cancelled', '2025-06-02 18:48:45'),
(6, 16, 25, 4, 1, 2, '2025-06-02', '\nCancellation reason: love it', 'cancelled', '2025-06-02 18:49:25'),
(7, 16, 25, 4, 1, 2, '2025-06-02', '', 'pending', '2025-06-02 18:51:49'),
(8, 16, 25, 4, 1, 2, '2025-06-02', '', 'pending', '2025-06-02 18:52:01'),
(9, 16, 25, 4, 1, 2, '2025-06-02', '', 'pending', '2025-06-02 18:53:56'),
(10, 16, 25, 6, 1, 1.5, '2025-06-03', '', 'pending', '2025-06-03 07:47:21');
...
(16, 'Computer Science', 'Degree second year', 'Hi! I’m currently pursuing a degree in Artificial Intelligence, with a strong passion for problem-solving and building efficient algorithms. \r\nI specialize in Data Structures and C++ programming, and I enjoy helping others understand complex concepts by breaking them down into simpler steps.\r\n\r\nAs a peer tutor, my goal is to support students in mastering the foundations of programming and algorithm design. Whether you\'re preparing for exams, struggling with code, or just want to deepen your understanding, I’m here to help!', 'yes', 0, 0.00, 0),
...
INSERT INTO `tutorsubject` (`id`, `tutor_id`, `subject_id`, `course_id`, `hourly_rate`, `programme_id`) VALUES
(10, 16, 4, 4, 20.00, 1),
(11, 16, 4, 6, 60.00, 1);
...
(16, 'mingwen', '$2y$10$9BtLg9AS1waXzlUC7YArjeiRhxLax9jZFSa5pLbcv5oKgLAzlXb/i', 'mingwen123@gmail.com', 'tutor', 'mengwen', 'koh', '0123456789', 'uploads/profile_images/6809e5c4739bb_OIP.jpg 1.jpg', 1, '2025-04-23 17:15:45', NULL),
...
(25, 'ey', '$2y$10$Au/0zMtHJsITNN2sWIaEkeYJ3jjnOOzz/DywyhpFvHDv3CwPAN0fK', '123@student.mmu.edu.my', 'student', 'Ong', 'EY', '0123456789', 'uploads/profile_images/683ea7a23713f_Screenshot 2025-04-14 125649.png', 1, '2025-05-30 05:48:07', NULL);
...
--
ALTER TABLE `session_requests`
  ADD CONSTRAINT `session_requests_ibfk_1` FOREIGN KEY (`tutor_id`) REFERENCES `user` (`user_id`),
  ADD CONSTRAINT `session_requests_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `user` (`user_id`),
  ADD CONSTRAINT `session_requests_ibfk_3` FOREIGN KEY (`course_id`) REFERENCES `courses` (`course_id`),
  ADD CONSTRAINT `session_requests_ibfk_4` FOREIGN KEY (`location_id`) REFERENCES `location` (`location_id`);
