...
CREATE TABLE `session_requests` (
  ...
  `course_id` int(11) NOT NULL,
  `location_id` int(11) NOT NULL,
  `duration` decimal(5,2) NOT NULL COMMENT 'Session duration in hours',
...
(16, 'mingwen', '$2y$10$9BtLg9AS1waXzlUC7YArjeiRhxLax9jZFSa5pLbcv5oKgLAzlXb/i', 'mingwen123@gmail.com', 'tutor', 'mingwengg', 'koh', '0123456789', 'Uploads/profile_images/16_1749896371_OIP.png', 1, '2025-04-23 17:15:45', NULL),
