...
INSERT INTO `course2` (`course_id`, `subject_id`, `course_code`, `course_name`, `description`, `programme_id`) VALUES
...
--
ALTER TABLE `course2`
  ADD CONSTRAINT `course2_ibfk_1` FOREIGN KEY (`programme_id`) REFERENCES `programme` (`programme_id`),
...
--
ALTER TABLE `tutorsubject`
  ADD CONSTRAINT `fk_course_new` FOREIGN KEY (`course_id`) REFERENCES `course2` (`course_id`),
