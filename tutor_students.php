...
<head>
    ...
    <body>
        <nav class="navbar">
            ...
            <div class="nav-links">
                <a href="tutor_main_page.php"></i> Dashboard</a>
                <a href="tutor_profile_page.php"></i> Profile</a>
                <a href="tutor_requests.php"> Appointment Requests
                    <?php if ($pending_requests > 0): ?>
                        <span><?php echo $pending_requests; ?></span>
                    <?php endif; ?>
                </a>
                <a href="tutor_students.php" class="active"></i>My Students</a>
                <a href="tutor_messages.php"> Messages
