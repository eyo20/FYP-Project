...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['update_profile'])) {
        ...
        if ($user_updated && $profile_updated) {
            ...
            if (!$profile_updated) {
                $error_message .= " (导师资料" . ($profile_exists ? "更新" : "创建") . "失败)";
            }
        }
    }
        ...
        if (!empty($subject_id) && !empty($hourly_rate)) {
            ...
            if ($subject_result->num_rows > 0) {
                ...
                if ($subject_updated) {
                    $success_message = "科目价格已成功更新！";
                } else {
                    $error_message = "更新科目价格时出错，请重试！";
                }
            } else {
                // 添加新科目
                ...
                if ($subject_added) {
                    ...
                    $error_message = "添加科目时出错，请重试！";
                }
            }
        } else {
            $error_message = "请选择科目并设置价格！";
        }
        ...
        if (!empty($subject_id)) {
            ...
            if ($subject_removed) {
                ...
                $error_message = "移除科目时出错，请重试！";
            }
        } else {
            $error_message = "无效的科目ID！";
        }
    }
...
<body>
    <nav class="navbar">
        ...
        <div class="nav-links">
            <a href="tutor_main_page.php">Schedule</a>
            <a href="tutor_profile.php" class="active">Profile</a>
            <a href="tutor_requests.php">Requests
